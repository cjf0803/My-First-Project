        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="font-family: 'Matura MT Script Capitals';font-size: 50px">TigerCjf</a>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/cart/findCart">购物车 <span class="badge">${count1}</span></a></li>
                    ...
                    <form action="/goods/customerFindGoodsMo" method="post" class="navbar-form navbar-right" role="search">
...
<form action="/goods/customerFindGoods" method="post">
<div class="productList wrap">
    <div class="content">
        <div class="productListContent">
            <div class="title">
                热门产品  <span class="badge">${count}</span>
            </div>

            <c:forEach items="${list}" var="p">
            <div class="hotKind">
                <div class="hotItem">
                    <a href="/goods/customerFindByGimage?gimage=${p.gimage}" class="hotImgA img-light">
        ...
        <div class="pageBox">
            <a href="/goods/customerFindGoods?index=1">首页</a>
                <c:if test="${index>1}">
                    <a href="/goods/customerFindGoods?index=${index-1}">上页</a>
                </c:if>
                <c:if test="${index<totalPage}">
                    <a href="/goods/customerFindGoods?index=${index+1}">下页</a>
                </c:if >
                <c:if test="${index!=totalPage}">
                    <a href="/goods/customerFindGoods?index=${totalPage}">末页</a>
                </c:if>
