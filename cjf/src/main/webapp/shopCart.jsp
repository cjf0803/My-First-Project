            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#">购物车<span class="badge">${count}</span></a></li>
...
<div class="shopCartBox wrap">
    <div class="content">
    <form action="/cart/findCart" method="post" >
        <div class="shopCartContent">
            <div class="noThings" style="display: none;">
                <h1>亦是空空空空如也</h1>
                <a href="/login.jsp" class="toLogin">立即登陆</a>
                <a href="/goods/customerFindGoods" class="toIndex">马上去购物</a>
            </div>
            <div class="shopCartItem">
                ...
                <div class="line">
                    ...
                    <div class="item deleteItem" onclick="delete1(${p.gid})">删除</div>
                </div>
                </c:forEach>
                <div class="totalLine">
                    ...
                    <div class="pageBox">
                        <a href="/cart/findCart?index=1">首页</a>
                        <c:if test="${index>1}">
                            <a href="/cart/findCart?index=${index-1}">上页</a>
                        </c:if>
                        <c:if test="${index<totalPage}">
                            <a href="/cart/findCart?index=${index+1}">下页</a>
                        </c:if >
                        <c:if test="${index!=totalPage}">
                            <a href="/cart/findCart?index=${totalPage}">末页</a>
                        </c:if>
                    </div>
                    <div class="fr toPayBtn">
                        <a href="/cart/findCart1" style="font-size: 23px;">去结算</a>
                    </div>
                </div>
            </div>
        </div>
