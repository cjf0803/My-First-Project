...
<section class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
        <ol class="breadcrumb">
            <li><a href="/lists/findLists">点击查询订单#</a></li>
        </ol>
        <h1 class="page-header">订单详情 <span class="badge">${count}</span></h1>
    </div>
    <div class="shopCartBox wrap">
        <div class="content" style="width: 975px">
            <form action="/lists/findByUname" method="post" >
                <div class="shopCartContent">
                    <div class="shopCartItem">
                        <div class="line title">
                            <div class="item">商品图片</div>
                            <div class="item">用户名</div>
                            <div class="item">商品id</div>
                        ...
                        <c:forEach items="${list}" var="p">
                            <div class="line">
                                ...
                                <div class="item ">${p.gid}</div>
                                <div class="item number">${p.gname}</div>
                                <div class="item totalPrice">￥${p.gprice}</div>
                                <div class="item totalPrice">${p.gnum}</div>
                        ...
                        <div class="totalLine" style="height: 80px">
                            ...
                            <div class="pageBox">
                                <a href="/lists/findByUname?index=1&uname=${uname}">首页</a>
                                <c:if test="${index>1}">
                                    <a href="/lists/findByUname?index=${index-1}&uname=${uname}">上页</a>
                                </c:if>
                                <c:if test="${index<totalPage}">
                                    <a href="/lists/findByUname?index=${index+1}&uname=${uname}">下页</a>
                                </c:if >
                                <c:if test="${index!=totalPage}">
                                    <a href="/lists/findByUname?index=${totalPage}&uname=${uname}">末页</a>
                                </c:if>
                            </div>
                            <div style="width: 100%;height: 50px;line-height: 50px;text-align: right;padding: 0 20px;box-sizing: border-box;">
                                商品总计:   <span  style="font-size: 30px;color: #ff9000;font-weight: 600;">￥${totalsum}</span>
                            </div>
                            <nav>
