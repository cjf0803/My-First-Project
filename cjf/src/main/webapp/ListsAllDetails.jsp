...
<section class="container-fluid">
    ...
    <div class="shopCartBox wrap">
        <div class="content" style="width: 975px">
            <form action="/lists/findListsAllDetails" method="post" >
                <div class="shopCartContent">
                    <div class="shopCartItem">
                        ...
                        <div class="totalLine" style="height: 80px">
                            ...
                            <div class="pageBox">
                                <a href="/lists/findListsAllDetails?index=1">首页</a>
                                <c:if test="${index>1}">
                                    <a href="/lists/findListsAllDetails?index=${index-1}">上页</a>
                                </c:if>
                                <c:if test="${index<totalPage}">
                                    <a href="/lists/findListsAllDetails?index=${index+1}">下页</a>
                                </c:if >
                                <c:if test="${index!=totalPage}">
                                    <a href="/lists/findListsAllDetails?index=${totalPage}">末页</a>
                                </c:if>
                            </div>
                            <nav>
