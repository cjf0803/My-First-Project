...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <form action="/goods/findGoods" method="post" >
                <h1 class="page-header">这是商品管理</h1>
                <ol class="breadcrumb">
                    <li><a href="/addgoods1.jsp">点击添加新商品#</a></li>
                </ol>
                <h1 class="page-header">商品管理 <span class="badge">${count}</span></h1>
                                ...
                                <article class="article-lists bloglist" id="LAY_bloglist" >
                                        ...
                                        <div class="content">
                                            ...
                                            <tr>
                                                ...
                                                <div style="font-size:35px;">
                                                   <span class="fc-blue" style="font-family: '微軟正黑體';margin-left: 150px">
                                                         商品名: ${p.gname}
                                                   </span>
                                                </div>
                                                ...
                                                <div style="font-size: 30px;">
                                                    <span class="fc-red" style="font-family: 'Impact';margin-left: 170px">
                                                    商品价格: ${p.gprice}
                                                    </span>
                                                </div>
                                            </td>
                                                <td>
                                                          <button type="button" class="btn btn-primary"  onclick="delete1(${p.gid})">删除</button><%--<a href="/person/deletePerson?id=${p.id}">删除</a>--%>
                                                           <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#myModal" onclick="updateGoods(${p.gid})">修改</button>
                                                </td>

                                            </tr>
                                        </div>
                                        <div class="read-more">
                                            <a href="#" class="fc-black f-fwb">继续欣赏</a>
                                        </div>
                                        <aside class="f-oh footer">
                                            <div class="f-fl tag">
                                                <span class="glyphicon glyphicon-tag"> 购物指南</span>
                                            </div>
                                            <div class="f-fr">
									<span class="glyphicon glyphicon-record">
										<a class="num">777</a>
                                                ...
                                                <span class="ml20">
										<a href="javascript:void(0)" class="glyphicon glyphicon-comment"> 1</a>
									</span>
                                            </div>
                                        </aside>
                                    </section>
                ...
                <footer class="message_footer">
                    <nav>
                        ...
                        <ul class="pagination pagenav">
                            ...
                            <li class="active"><a href="/goods/findGoods?index=1">首页</a></li>

                            <li>
                                <c:if test="${index>1}">
                                    <a href="/goods/findGoods?index=${index-1}">上页</a>
                                </c:if>
                            </li>

                            <li>
                                <c:if test="${index<totalPage}">
                                    <a href="/goods/findGoods?index=${index+1}">下页</a>
                                </c:if >
                            </li>
                            <li>
                                <c:if test="${index!=totalPage}">
                                    <a href="/goods/findGoods?index=${totalPage}">末页</a>
                                </c:if>
                            </li>
