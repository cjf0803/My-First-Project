...
<div class="productDetailBox wrap">
    <form action="/goods/customerFindByGimage" method="post" >
    ...
    <div class="content">
        <div class="detailBox">
            <div class="top">
                ...
                <div class="item">
                    <div style="font-size:35px;">
                        <span  style="font-family: '微軟正黑體'; color: #1a8fb4;">
                            商品名: ${p.gname}
                        </span>
                    </div>
                </br>
                    <div style="font-size: 20px;">
                        <span style="font-family: 'Bahnschrift' ;color: #b952c5">
                            商品描述: ${p.gdesc}
                        </span>
                    </div>
                </br>
                    <div style="font-size: 20px;">
                        <span style="font-family: 'Arimo';color: #fbb611">
                            商品生产时间: ${p.createtime}
                        </span>
                    </div>
                    </br>
                    <div style="font-size: 20px;">
                        <span class="fc-black" style="font-family: 'Magneto';">
                            商品库存: ${p.count}
                        </span>
                    </div>
                    </br>
                    <div class="buyLine">
                        <div style="font-size: 30px;">
                            <span style="font-family: Arimo;color: red;font-weight: bold">
                                商品价格: ${p.gprice}
                            </span>
                        </div>
                        <button type="button" class="addShopCart"  onclick="addCart(${p.gid})" >加入购物车</button>
                    </div>
                </div>
            </div>
        </div>
            <div class="bottom">
                ...
                <div class="conWords">
                    xdm听哥一句劝,记住:买定不离手啊！买定不离手啊！买定不离手啊！
                </div>
            </div>
        </div>
    </c:forEach>
