...
<section class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form action="/goods/findGoodsMo" method="post" class="navbar-form navbar-right" role="search">
                        <div class="input-group">
                            <input type="text" name="gname" class="form-control" autocomplete="off" placeholder="键入关键字搜索订单" maxlength="15">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <h1 class="page-header">订单模糊查询结果 <span class="badge">${count}</span></h1>
        </div>
        <div class="shopCartBox wrap">
            <div class="content" style="width: 975px">
                <form action="/lists/findListsMo" method="post" >
                    <div class="shopCartContent">
                        <div class="shopCartItem">
                            ...
                            <div class="totalLine" style="height: 80px">
                                ...
                                <div class="pageBox">
                                    <a href="/lists/findListsMo?index=1">首页</a>
                                    <c:if test="${index>1}">
                                        <a href="/lists/findLists?index=${index-1}&uname=${uname}">上页</a>
                                    </c:if>
                                    <c:if test="${index<totalPage}">
                                        <a href="/lists/findLists?index=${index+1}&uname=${uname}">下页</a>
                                    </c:if >
                                    <c:if test="${index!=totalPage}">
                                        <a href="/lists/findLists?index=${totalPage}&uname=${uname}">末页</a>
                                    </c:if>
                                </div>
                                <nav>
