...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="/goods/findGoodsMo" method="post" >
            </br>
                </br>
                </br>
                <h1 class="page-header">模糊查询商品结果</h1>
                ...
                <footer class="message_footer">
                    <nav>
                        ...
                        <ul class="pagination pagenav">
                            ...
                            <li class="active"><a href="/goods/findGoodsMo?index=1">首页</a></li>
                            <li>
                                <c:if test="${index>1}">
                                    <a href="/goods/findGoodsMo?index=${index-1}&gname=${gname}">上页</a>
                                </c:if>
                            </li>

                            <li>
                                <c:if test="${index<totalPage}">
                                    <a href="/goods/findGoodsMo?index=${index+1}&gname=${gname}">下页</a>
                                </c:if >
                            </li>
                            <li>
                                <c:if test="${index!=totalPage}">
                                    <a href="/goods/findGoodsMo?index=${totalPage}&gname=${gname}">末页</a>
                                </c:if>
                            </li>
